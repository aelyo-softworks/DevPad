...
namespace DevPad.Utilities.Grid
{
    public class PropertyGridDataProvider : IListSource
    {
        ...
        public virtual DynamicObject CreateDynamicObject() => new DynamicObject();
        public virtual PropertyGridProperty CreateProperty() => new PropertyGridProperty(this);
        ...
        protected virtual void Describe(PropertyGridProperty property, PropertyDescriptor descriptor)
        {
            ...
            AddDynamicProperties(descriptor.PropertyType.CustomAttributes.OfType<PropertyGridAttribute>(), property.TypeAttributes);
        }
        ...
        public virtual PropertyGridProperty CreateProperty(PropertyDescriptor descriptor)
        {
            ...
            if (property == null)
            {
                options = descriptor.PropertyType.CustomAttributes.OfType<PropertyGridOptionsAttribute>().FirstOrDefault();
                if (options != null)
                {
                    if (!forceReadWrite)
                    {
