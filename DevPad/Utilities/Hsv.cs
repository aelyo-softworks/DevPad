...
namespace DevPad.Utilities
{
    public struct Hsv : IEquatable<Hsv>
    {
        ...
        public static Hsv From(Color color) => new Hsv(GetHue(color.ScR, color.ScG, color.ScB), GetSaturation(color.ScR, color.ScG, color.ScB), GetValue(color.ScR, color.ScG, color.ScB));
