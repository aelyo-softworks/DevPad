...
namespace DevPad.Utilities
{
    public class DynamicObject : ICustomTypeDescriptor, INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        AttributeCollection ICustomTypeDescriptor.GetAttributes() => new AttributeCollection(_attributes.ToArray());
        ...
        EventDescriptorCollection ICustomTypeDescriptor.GetEvents() => new EventDescriptorCollection(_events.ToArray());
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties() => new PropertyDescriptorCollection(_properties.ToArray());
